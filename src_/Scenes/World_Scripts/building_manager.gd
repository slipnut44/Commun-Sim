...
func place_building():
	...
	b_instant.set_building_name(selected_building_type)
	...
	# once the building is fixiated in the scene, use Base_Building's on_placed()
	# to initialize the buildings respective agents
	b_instant.on_placed()
